                        ...
                        <div>
                            <span>
                                <button type="button" class="btn btn-primary"><a class="nav-link "
                                        href="{{ route('add.dossier') }}"><span
                                            class="item-name">Ajouter</span></a></button>
                            </span>

                            <span>
                                <button type="button" class="btn btn-primary"><a class="nav-link "
                                        href="{{ route('archive.dossier') }}"><span
                                            class="item-name">Archives</span></a></button>
                            </span>
                        </div>
                    </div>
                    <div class="card-body">
                                            ...
                                            <td>
                                                <div class="flex align-items-center list-user-action">
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip"
                                                        data-bs-placement="top" title="Modifer"
                                                        href="{{ route('update.dossier.view', $dossier->id) }}">
                                                        <span class="btn-inner">
                                                            <svg class="icon-20" width="20" viewBox="0 0 24 24"
                                                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path
                                                    ...
                                                    <a class="btn btn-sm btn-icon btn-danger" data-bs-toggle="tooltip"
                                                        ...
                                                        <span class="btn-inner">
                                                            <form action="{{ route('delete.dossier', $dossier->id) }}"
