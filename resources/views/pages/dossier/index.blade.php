...
<div class="conatiner-fluid content-inner mt-n5 py-0">
    <div class="bd-example  m-2">
        ...
        <div class="card-header d-flex justify-content-between">
            ...
            <div>
                <button type="button" class="btn btn-primary"><a class="nav-link " href="{{ route('add.dossier') }}"><span class="item-name">Ajouter</span></a></button>
            </div>
        </div>
        <div class="card-body">
                ...
                <table id="datatable" class="table table-striped" data-toggle="data-table">
                    ...
                    @foreach ($dossiers as $dossier )
                        <tr  class="{{ $dossier->has_issue ? 'table-warning' : '' }}">
                            ...
                            <td>
                                 <span>
                                    <a href="{{ route('show.dossier.view', $dossier->id) }}">
                                        <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">       <path fill-rule="evenodd" clip-rule="evenodd" d="M15.1614 12.0531C15.1614 13.7991 13.7454 15.2141 11.9994 15.2141C10.2534 15.2141 8.83838 13.7991 8.83838 12.0531C8.83838 10.3061 10.2534 8.89111 11.9994 8.89111C13.7454 8.89111 15.1614 10.3061 15.1614 12.0531Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M11.998 19.355C15.806 19.355 19.289 16.617 21.25 12.053C19.289 7.48898 15.806 4.75098 11.998 4.75098H12.002C8.194 4.75098 4.711 7.48898 2.75 12.053C4.711 16.617 8.194 19.355 12.002 19.355H11.998Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>                                </svg>
                                    </a>
                                </span>
                                <span>
                                    <a  href="{{ route('update.dossier.view', $dossier->id) }}">
                                ...
                                <span>
                                    <form action="{{ route('delete.dossier', $dossier->id) }}" method="POST" style="display:inline;">
                                        @csrf
                                        @method('DELETE')
