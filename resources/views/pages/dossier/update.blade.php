...
@section('title')
Modiffier un dossier {{$dossier->dg}}
@endsection
                        ...
                        <div class="card-body">
                            <form method="POST" enctype="multipart/form-data" action="{{route('update.dossier', $dossier)}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="dg" class="form-control" value="{{$dossier->dg}}"  maxlength="5" placeholder="Sans le DG" required  >
                                </div>

                                <div class="form-group">
                                    <label class="form-label" for="">Tiers payant</label>
                                    <input type="text" name="tiers_payant" class="form-control" value="{{$dossier->tiers_payant}}" placeholder="P200/C238/H1" >
                                </div>

                                <div class="form-group">
                                    <label class="form-label" for="">Nombre de feuilles</label>
                                    <input type="number" name="nombre_fiches" class="form-control" value="{{$dossier->nombre_fiches}}"  required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check d-block">
                                        <input class="form-check-input" type="radio" name="categorie" value="normal" {{ old('categorie', $dossier->categorie) == 'normal' ? 'checked' : '' }}>
                                ...
                                <div class="form-check d-block">
                                    <input class="form-check-input" type="radio" name="categorie" value="cscom"  {{ old('categorie', $dossier->categorie) == 'cscom' ? 'checked' : '' }}>
                                ...
                                <div class="form-check d-block">
                                    <input class="form-check-input" type="radio" name="categorie" value="hopital"  {{ old('categorie', $dossier->categorie) == 'hopital' ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="form-check d-block">
                                       <input class="form-check-input" type="radio" name="type" value="pharmacie" {{ old('type', $dossier->type) == 'pharmacie' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="pharmacie">
                                            Pharmacies
                                        </label>
                                    </div>
                                    <div class="form-check d-block">
                                       <input class="form-check-input" type="radio" name="type" value="examens" {{ old('type', $dossier->type) == 'examens' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check d-block">
                                       <input class="form-check-input" type="radio" name="type" value="soins" {{ old('type', $dossier->type) == 'soins' ? 'checked' : '' }}>
